# Generated by Django 2.1.1 on 2018-10-22 09:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.BooleanField(default=True)),
                ('faculty_member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.KERNEL_FACULTYMEMBER_MODEL)),
                ('scholar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.KERNEL_STUDENT_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'swappable': 'FACULTY_BIODATA_HONOR_MODEL',
            },
        ),
        migrations.CreateModel(
            name='Interest',
